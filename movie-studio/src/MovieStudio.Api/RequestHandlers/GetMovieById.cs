...
namespace MovieStudio.Api.RequestHandlers
{
    internal static class GetMovieById
    {
        ...
        public class Handler : IRequestHandler<Request, Movie>
        {
            ...
            {
                ["111"] = new Movie { Id = "111", Title = "The Batman", Released = new DateTime(2021, 01, 01), Genres = new[] { "Action", "Crime", "Drama" }, Directors = new[] { "111" }, Writers = new[] { "111" }, Cast = new[] { "444", "777" } },
                ...
                ["333"] = new Movie { Id = "333", Title = "The Prestige", Released = new DateTime(2006, 01, 01), Genres = new[] { "Drama", "Mystery", "Sci-Fi" }, Directors = new[] { "222", "333" }, Writers = new[] { "222" }, Cast = new[] { "555", "888", "111" } },
            };
